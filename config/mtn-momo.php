...
return [
    ...
    'api' => [
        // API base URI.
        'base_uri' => env('MOMO_API_BASE_URI', 'http://localhost/TEG/public/'),

        // Register client ID URI
        'register_id_uri' => env('MOMO_API_REGISTER_ID_URI', '/apiuser'),

        // Validate client ID URI
        'validate_id_uri' => env('MOMO_API_VALIDATE_ID_URI', 'apiuser/{clientId}'),

        // Generate client secret URI
        'request_secret_uri' => env('MOMO_API_REQUEST_SECRET_URI', 'apiuser/{clientId}/apikey'),
    ],
